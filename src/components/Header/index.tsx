      ...
      <InputsContainer>
        ...
        <CustomSelect>
          <div className="select-btn" onClick={() => setUlClass(state => state === '' ? 'active' : '')}>
            <span className="select-btn-text" data-testid="selected-font-text">{selectedFont}</span>
            <svg width="13" height="9" viewBox="0 0 13 9" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path d="M1 1L7 7L13 1" stroke="#A445ED" strokeWidth="1.5"/>
            </svg>
          </div>           
          <ul className={ulClass} data-testid="font-list-menu">
        ...
        <SwitchContainer>
          <Switch 
            data-testid="switch-handler-theme"
          ...
          <svg data-testid="svg-theme" width="22" height="22" viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg">
